...
public class DtoItemSkuStock extends BasicModel {
	private Long id;
	...
	private DtoItemStock itemStock;
	...
	public DtoItemStock getItemStock() {
		return itemStock;
	}

	public void setItemStock(DtoItemStock itemStock) {
