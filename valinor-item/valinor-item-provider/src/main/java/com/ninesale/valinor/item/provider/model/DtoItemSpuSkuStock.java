...
public class DtoItemSpuSkuStock extends BasicModel{
    private Long id;
    ...
    private List<DtoItemSkuStock> itemSkuList;
	...
	public List<DtoItemSkuStock> getItemSkuList() {
		return itemSkuList;
	}

	public void setItemSkuList(List<DtoItemSkuStock> itemSkuList) {
