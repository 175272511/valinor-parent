 ...
 */
public class DubboItemSpuSkuStock extends BasicSeriModel{
    /**
	 * 
	 */
	 ...
	 * SPU对应的SKU列表
	 */
    private List<DubboItemSkuStock> skuList;
	...
	public List<DubboItemSkuStock> getSkuList() {
		return skuList;
	}

	public void setSkuList(List<DubboItemSkuStock> skuList) {
