...
public class SystemUtil {
	...
	public static String get(final String key, String defaultValue) {
		...
		try {
			...
			XLog.warn(e, "Unable to retrieve a system property '{}'; default values will be used.", key);
		}
	...
	public static Properties props() {
		...
		try {
			...
			XLog.warn(e, "Unable to retrieve a system propertys; default values will be used.");
		}
		return props;
	}
