...
public class ClientParentCateg extends BasicModel{
	...
	private List<ClientBaseinfoCateg> subCateList;
	...
	public List<ClientBaseinfoCateg> getSubCateList() {
		return subCateList;
	}

	public void setSubCateList(List<ClientBaseinfoCateg> subCateList) {
