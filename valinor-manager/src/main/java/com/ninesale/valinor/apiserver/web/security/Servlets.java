...
import com.pubpi.common.utils.Encodes;
...
public class Servlets {
	...
	// try {
	// throw new
	// Exception("检测到“app.properties”中没有配置“web.staticFile”属性。配置示例：\n#静态文件后缀\n"
	...
	// && !StringUtils.endsWithAny(uri, ".jsp") && !StringUtils.endsWithAny(uri,
	// ".java")){
	// return true;
	// }
	// return false;
