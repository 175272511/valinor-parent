...
public class CommonNoteImgInfo extends BasicModel {
	 ...
	 * 图片标签信息
	 */
	private List<CommonImgTagGroup> imgTagGroupList;
	 ...
	 */
	public List<CommonImgTagGroup> getImgTagGroupList() {
	 ...
	 */
	public void setImgTagGroupList(List<CommonImgTagGroup> imgTagGroupList) {
