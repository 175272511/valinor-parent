...
public class ClientItem2Tag extends BasicModel{
	@Mapping(value = "id")
    ...
    private ClientBrandTag brandTag;
	...
	public ClientBrandTag getBrandTag() {
		return brandTag;
	}

	public void setBrandTag(ClientBrandTag brandTag) {
